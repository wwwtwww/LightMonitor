    ...
    <el-card shadow="never" style="margin-bottom: 20px;">
      <template #header>
        <div class="panel-header">
          <b>Oracle Live Metrics</b>
        </div>
      </template>
      <el-row :gutter="12">
        <el-col :span="6">
          <div class="info-item">
            <div class="info-label">QPS (Execute/s)</div>
        ...
        <el-col :span="6">
          <div class="info-item">
            ...
            <div class="info-value">{{ latestExtra.activeSessions ?? 0 }}</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="info-item">
        ...
        <el-col :span="6">
          <div class="info-item">
            ...
            <div class="info-value">{{ Math.round(Number(latestPoint.resp_time || 0)) }}</div>
          </div>
        </el-col>
      </el-row>
    </el-card>
